...
/**
 * @params:      Request
 * @purpose:     To hotel forgot password
*/
controller.forgotPassword = async (req, res) => {
    try{
        ...
        if(!isUser){
            ...
            var mesg = 'Hi '+ isUser.first_name +' '+ isUser.last_name +', <br> To reset your password, click on the link below: <br> <a href="' + config.BASE_URL + 'api/v1/hotel/reset_password/'+token+'">'+ config.BASE_URL + 'api/v1/hotel/reset_password/'+token+'</a>';
